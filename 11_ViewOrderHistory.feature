...
Scenario: View Order History (Normal flow)
...
Scenario: View Order Details (Normal flow)
...
Scenario: Filter Order History (Alternate flow)
  Given the user is on the order history page
