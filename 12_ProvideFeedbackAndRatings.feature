...
Scenario: Provide Feedback and Rating
...
Scenario: Feedback and Rating Displayed on Textbook Details Page
...
Scenario: Feedback and Rating Displayed on Profile Page
...
Scenario: Feedback and Rating Before Purchase or Sale
