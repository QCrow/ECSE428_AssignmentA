...
Scenario: Choose Textbook Condition
...
Scenario: Display Textbook Condition
...
Scenario: Provide Additional Details in Description Field
  Given the student seller is listing a textbook for sale
  When the student seller is prompted to describe the condition of the textbook
...
Scenario: Invalid Textbook Condition
  Given the student seller is listing a textbook for sale
