...
Scenario: User rates a textbook (Normal flow)
...
Scenario: User writes a review for a textbook (Normal flow)
Given the user has purchased a textbook
When the user navigates to the textbook's details page
Then the user should be able to write a review for the textbook
And the user should be able to submit their review

Scenario: User rates and reviews another user (Alternate flow)
...
Scenario: System displays error message for invalid content (Error flow)
