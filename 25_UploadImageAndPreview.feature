...
Scenario: Verify ability to upload multiple images of textbook
...
Scenario: Verify images displayed on textbook's details page
...
Scenario: Verify primary image selection
Given the student seller has uploaded multiple images of the textbook
...
Scenario: Verify error message for invalid image upload
