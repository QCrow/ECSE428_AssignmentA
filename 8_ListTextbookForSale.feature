...
Scenario: List Textbook with Required Information
...
Scenario: Listed Textbooks Displayed in Search Results
...
Scenario: Edit or Remove Listed Textbook
  Given the student seller has listed one or more textbooks for sale
...
Scenario: Book Already Listed for Sale
