...
Scenario: Enter Shipping and Payment Information and Complete Purchase (Normal flow)
...
Scenario: Choose Shipping Option (Normal flow)
...
Scenario: Choose Payment Option (Normal flow)
  Given the student buyer is on the checkout page
