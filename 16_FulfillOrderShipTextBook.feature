...
Scenario: Mark Order as Fulfilled (Normal flow)
...
Scenario: Provide Tracking Information (Normal flow)
...
Scenario: Choose Shipping Option and Set Shipping Cost (Normal flow)
  Given the student seller has received an order for a textbook
...
Scenario: Mark Order as Fulfilled Before Shipping Textbook (Error flow)
  Given the student seller has received an order for a textbook
