...
Scenario: Receive Payment (Normal flow)
...
Scenario: View Sale Details (Normal flow)
  Given the student seller has completed a sale
...
Scenario: Resolve Sale Dispute (Alternate flow)
...
Scenario: Mark Sale as Complete Before Payment Received (Error flow)
  Given the student seller has completed a sale
