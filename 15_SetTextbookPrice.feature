...
Scenario: Set Textbook Price (Normal flow)
...
Scenario: Display and Negotiate Textbook Price (Normal flow)
...
Scenario: Agree Upon Final Price (Normal flow)
...
Scenario: Invalid Textbook Price (Error flow)
  Given the student seller is listing a textbook for sale
