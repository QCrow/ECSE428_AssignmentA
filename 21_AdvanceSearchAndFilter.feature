...
Scenario: Filter Search Results by Condition, Price, and Date Posted (Alternate flow)
...
Scenario: Sort Search Results by Relevance, Price, or Date Posted (Alternate flow)
Given the user has performed a search for textbooks
...
Scenario: Display Error Message for Invalid Search Queries (Error flow)
